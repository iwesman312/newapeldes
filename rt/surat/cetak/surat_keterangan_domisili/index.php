...
<div>
	...
	<div id="isi3">
		...
		<table width="100%">
		<tr>
				<td class="indentasi">Data Individu yang tinggal :</td>
			</tr>
		</table>
		<table width="100%" style="text-transform: capitalize;" border="1px" cellspacing="0" align="center">
			...
			<th width="140">Jenis Kelamin L/P</th>
			<th width="140">Hub Dalam KK</th>
			<tr>
				<td><?php echo $row['no']; ?></td>
				<td class="identasi"><?php echo $row['nama1']; ?></td>
				<td align="center"><?php echo $row['tanggal3']; ?></td>
				<td align="center"><?php echo $row['jk']; ?></td>
				<td align="center"><?php echo $row['hub1']; ?></td>
			</tr>
			<tr>
				<td><?php echo $row['no2']; ?></td>
				<td class="identasi"><?php echo $row['nama2']; ?></td>
				<td align="center"><?php echo $row['tanggal4']; ?></td>
		...
		<table width="100%">
			<tr>
				<td class="indentasi">Yang tersebut diatas benar bertempat tinggal di alamat tersebut sejak : <?php echo $row['sejak']; ?> 
				</td>
			</tr>
		</table>
		<table width="100%">
