...
<div>
	...
	<div id="isi3">
		<table width="100%">
			<tr>
				<td class="indentasi">Melaksanakan Ketentuan Pasal 81 Undang-undang No. 5 Tahun 1974, maka berdasarkan surat keterangan Kepala Desa Susukan Tanggal <?php
					$tanggal = date('d F Y');
				...
				?> NOMOR: <?php echo $row['no_surat']; ?> tentang permohonan keterangan catatan kepolisian:
				</td>
			</tr>
		</table>
		<br>
		<table width="100%" style="text-transform: capitalize;">
			...
			<table width="100%">
			<tr>
				<td class="indentasi">Dengan ini menerangkan bahwa berdasarkan data dan catatan yang ada serta sepanjang pengetahuan kami Orang tersebut adalah penduduk / warga Desa Susukan Kecamatan Bojonggede Kabupaten Bogor. Berdasarkan data yang di lampirkan tersebut di bawah ini:
				</td>
			</tr>
		</table>
		<tr></tr>
			...
			<table width="100%">
			<tr>
				<td class="indentasi">Surat keterangan ini diberikan untuk keperluan :
				</td>
			</tr>
		</table>
		<tr></tr>
