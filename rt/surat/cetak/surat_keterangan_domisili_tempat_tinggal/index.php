<?php 
	include ('../../permintaan_surat/konfirmasi/part/akses.php');
  	...
  	$id = $_GET['id'];
  	$qCek = mysqli_query($connect,"SELECT penduduk.*, surat_keterangan_domisili_tempat_tinggal.* FROM penduduk LEFT JOIN surat_keterangan_domisili_tempat_tinggal ON surat_keterangan_domisili_tempat_tinggal.nik = penduduk.nik WHERE surat_keterangan_domisili_tempat_tinggal.id_skdtt='$id'");
...
<div>
	...
	<div id="isi3">
		<table width="100%">
			<tr>
				<td class="indentasi">Yang bertanda tangan di bawah ini,KEPALA DESA <a style="text-transform: capitalize;"><?php echo$rows['nama_desa']; ?>, Kecamatan <?php echo $rows['kecamatan']; ?>, <?php echo $rows['kota']; ?></a>, menerangkan berdasarkan surat pengantar RT<?php echo $row['rt'];?><b>/RW<?php echo $row['rw']; ?>, Desa <?php echo $rows['nama_desa']; ?>, Kecamatan <?php echo $rows['kecamatan']; ?>, <?php echo $rows['kota']; ?> Tanggal :<?php echo $row['tanggal'];?> tentang permohonan Keterangan Domisili tempat tinggal, maka dengan ini kami menerangkan bahwa :
				</td>
			</tr>
		</table>
		<table width="100%" style="text-transform: capitalize;">
			...
			<tr>
				<td width="35%" class="indentasi">Alamat Sekarang :</td>
				<td width="2%">:</td>
				<td width="63%" style="text-transform: uppercase;"><?php echo $row['alamat2']; ?></td>
			</tr>
		</table>
		<br>
		<table width="100%">
			<tr>
				<td class="indentasi">Nama tersebut diatas benar bertempat tinggal di alamat tersebut sejak : <?php echo $row['sejak']; ?> 
				</td>
			</tr>
		</table>
		<table width="100%">
		...
		<table width="100%">
			<tr>
				<td class="indentasi">dan berlaku selama 3 bulan sejak tanggal dibuatkannya
				</td>
			</tr>
		</table>
		<table width="100%">
			<tr>
				<td class="indentasi">Demikian surat keterangan ini dibuat dengan sebenar-benarnya untuk dapat dipergunakan sebagaimana mestinya.
				</td>
			</tr>
		</table>
	</div>
