...
<div>
	<table width="100%">
		...
		<div class="header">
			...
			<h5 class="kop2" style="text-transform: capitalize;"><?php echo $rows['kecamatan'] ." " . " " . $rows['kota'] ." "."Kode Pos".$rows['kode_pos']; ?></h5>
				<hr>
			</div>
		</div>
		<br>
	...
	<div id="isi3">
		<table width="100%">
			<tr>
				<td class="indentasi">Yang bertanda tangan dibawah ini Kepala Desa Susukan Kecamatan Bojonggede Kabupaten Bogor, dengan ini menyatakan bahwa :
				</td>
			</tr>
		</table>
		<br>
		<table width="100%" style="text-transform: capitalize;">
			...
			<table width="100%">
			<tr>
				<td class="indentasi">Adalah benar warga kami dan saat ini yang bersangkutan adalah keluarga tidak mampu layak untuk mendapatkan bantuan : <?php echo $row['keperluan']; ?>
				</td>
			</tr>
		</table>
		<tr></tr>
		...
		<table width="100%">
			<tr>
				<td class="indentasi">Demikian surat keterangan ini dibuat guna periksa bagi yang berkepentingan dan dipergunakan sebagaimana mestinya.
				</td>
			</tr>
		</table>
	</div>
