      ...
      <div class="col-md-12">
        <div class="box box-default">
          <div class="box-header with-border">
            <h2 class="box-title"><i class="fas fa-envelope"></i> Konfirmasi Surat Pengantar KTP</h2>
                ...
                <div class="col-md-6">
                  <div class="box-body">
                    ...
                    <div class="form-group">
                      ...
                      <input type="hidden" name="id" value="<?php echo $row['id_sktp']; ?>" class="form-control">
                    
                    <div class="form-group">
                      <label class="col-sm-3 control-label">No KK</label>
                      <div class="col-sm-9">
                        <input type="text" name="fnokk" style="text-transform: uppercase;" value="<?php echo $row['no_kk']; ?>" class="form-control" readonly>
                      </div>
                    </div>
                  </div>
                </div>
