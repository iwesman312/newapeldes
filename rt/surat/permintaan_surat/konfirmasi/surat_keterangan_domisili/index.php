      ...
      <div class="col-md-12">
        <div class="box box-default">
          <div class="box-header with-border">
            <h2 class="box-title"><i class="fas fa-envelope"></i> Konfirmasi Surat Keterangan Domisili Tempat Tinggal Keluarga</h2>
          ...
          <div class="box-body">
            <form class="form-horizontal" method="post" action="update-konfirmasi.php">
              ...
              <h5 class="box-title pull-right" style="color: #696969;"><i class="fas fa-info-circle"></i> <b>Informasi Saat ini</b></h5>
              <br><hr style="border-bottom: 1px solid #DCDCDC;">
              <div class="row">
                <div class="col-md-6">
                  <div class="box-body">
                    ...
                    <div class="form-group">
                      <label class="col-sm-3 control-label">Tanggal Surat RT</label>
                      <div class="col-sm-9">
                        <td></td><input type="text" name="ftanggal2" style="text-transform: uppercase;" value="<?php echo $row['tanggal']; ?>" class="form-control" readonly>
                      </div>
                    </div>
                    
                    <div class="form-group">
                      <label class="col-sm-3 control-label">Tinggal Sejak</label>
                      <div class="col-sm-9">
                        <input type="text" name="fsejak" style="text-transform: uppercase;" value="<?php echo $row['sejak']; ?>" class="form-control" readonly>
                      </div>
                    </div>
                  </div>
                </div>
                ...
                <div class="col-md-6">
                  <div class="box-body">
                    <div class="form-group">
                      ...
                      <div class="col-sm-9">
                        <input type="text" name="fno" style="text-transform: uppercase;" value="<?php echo $row['no']; ?>" class="form-control" readonly>
                      </div>
                    </div>
                    ...
                    <div class="form-group">
                      ...
                      <div class="col-sm-9">
                        <input type="text" name="ftanggal3" style="text-transform: uppercase;" value="<?php echo $row['tanggal3']; ?>" class="form-control" readonly>
                      </div>
                    </div>
                    ...
                    <div class="form-group">
                      <label class="col-sm-3 control-label">Jenis Kelamin</label>
                      <div class="col-sm-9">
                        <input type="text" name="fjk" style="text-transform: uppercase;" value="<?php echo $row['jk']; ?>" class="form-control" readonly>
                      </div>
                    </div>
                    ...
                    <div class="form-group">
                      ...
                      <div class="col-sm-9">
                        <input type="text" name="fhub1" style="text-transform: uppercase;" value="<?php echo $row['hub1']; ?>" class="form-control" readonly>
                      </div>
                    </div>
                  </div>
                </div>
