                ...
                <div class="col-md-6">
                  <div class="box-body">
                    ...
                    <div class="form-group">
                      ...
                      <div class="col-sm-8">
                        <input type="text" name="fnik" maxlength="16" onkeypress="return hanyaAngka(event)" class="form-control" value="<?php echo $row['nik']; ?>" >
                        <script>
                    ...
                    <div class="form-group">
                      ...
                      <div class="col-sm-8">
                        <select name="frt" class="form-control" value="<?php echo $row['rt']; ?>" required>
                          ...
                          <option <?php if($row['rt'] == '007'){ echo 'selected'; } ?> value="007">007</option>
                          <option <?php if($row['rt'] == '008'){ echo 'selected'; } ?> value="008">008</option>
                        </select>
                      </div>
                    </div>
                    <div class="form-group">
                      ...
                      <div class="col-sm-8">
                        <select name="frw" class="form-control" value="<?php echo $row['rw']; ?>" required>
                          ...
                          <option <?php if($row['rw'] == '004'){ echo 'selected'; } ?> value="004">004</option>
                          <option <?php if($row['rw'] == '005'){ echo 'selected'; } ?> value="005">005</option>
                          <option <?php if($row['rw'] == '006'){ echo 'selected'; } ?> value="006">006</option>
                          <option <?php if($row['rw'] == '007'){ echo 'selected'; } ?> value="007">007</option>
                          <option <?php if($row['rw'] == '008'){ echo 'selected'; } ?> value="008">008</option>
                          <option <?php if($row['rw'] == '009'){ echo 'selected'; } ?> value="009">009</option>
                          <option <?php if($row['rw'] == '010'){ echo 'selected'; } ?> value="010">010</option>
                        </select>
                      </div>
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                      ...
                      <div class="col-sm-8">
                        <select name="fpend_ditempuh" class="form-control" value="<?php echo $row['pend_ditempuh']; ?>" required>
                          ...
                          <option <?php if($row['pend_ditempuh'] == 'HIDUP'){ echo 'selected'; } ?> value="HIDUP">HIDUP</option>
                          <option <?php if($row['pend_ditempuh'] == 'LAHIR'){ echo 'selected'; } ?> value="LAHIR">LAHIR</option>
                          <option <?php if($row['pend_ditempuh'] == 'MATI'){ echo 'selected'; } ?> value="MATI">MATI</option>
                          <option <?php if($row['pend_ditempuh'] == 'PINDAH'){ echo 'selected'; } ?> value="PINDAH">PINDAH</option>
                          <option <?php if($row['pend_ditempuh'] == 'DATANG'){ echo 'selected'; } ?> value="DATANG">DATANG</option>
