...
<div class="content-wrapper">
  ...
  <section class="content">      
    <div class="row">
      ...
      <td>Jumlah Penduduk Pada RW 001 : <b> <?php echo $query3; ?></b></td>
      ...
      $query =mysqli_num_rows($sql);
      $query2=mysqli_num_rows($sql2);
      $sql3 =mysqli_query($connect, "SELECT * FROM penduduk WHERE rw='002'");
      $query3 =mysqli_num_rows($sql3);?>
      <tr><td>Jumlah Laki-laki Pada RW 002 : <b> <?php echo $query; ?></b></td>
        <td>Jumlah Perempuan Pada RW 002 : <b> <?php echo $query2; ?></b></td>
        <td>Jumlah Penduduk Pada RW 002 : <b> <?php echo $query3; ?></b></td>
        </tr>
      ...
      $query =mysqli_num_rows($sql);
      $query2=mysqli_num_rows($sql2);
      $sql3 =mysqli_query($connect, "SELECT * FROM penduduk WHERE rw='003'");
      $query3 =mysqli_num_rows($sql3);
      ?>
      <tr><td>Jumlah Laki-laki Pada RW 003 : <b> <?php echo $query; ?></b></td>
      <td>Jumlah Perempuan Pada RW 003 : <b> <?php echo $query2; ?></b></td>
      <td>Jumlah Penduduk Pada RW 003 : <b> <?php echo $query3; ?></b></td>
      </tr>
      <?php
      ...
      $query =mysqli_num_rows($sql);
      $query2=mysqli_num_rows($sql2);
      $sql3 =mysqli_query($connect, "SELECT * FROM penduduk WHERE rw='004'");
      $query3 =mysqli_num_rows($sql3);
      ?>
      <tr><td>Jumlah Laki-laki Pada RW 004 : <b> <?php echo $query; ?></b></td>
      <td>Jumlah Perempuan Pada RW 004 : <b> <?php echo $query2; ?></b></td>
      <td>Jumlah Penduduk Pada RW 004 : <b> <?php echo $query3; ?></b></td>
      ...
      $query =mysqli_num_rows($sql);
      $query2=mysqli_num_rows($sql2);
      $sql3 =mysqli_query($connect, "SELECT * FROM penduduk WHERE rw='005'");
      $query3 =mysqli_num_rows($sql3);
     ?>
      <tr><td>Jumlah Laki-laki Pada RW 005 : <b> <?php echo $query; ?></b></td>
        <td>Jumlah Perempuan Pada RW 005 : <b> <?php echo $query2; ?></b></td>
        <td>Jumlah Penduduk Pada RW 005 : <b> <?php echo $query3; ?></b></td>
      </tr>
      <?php
      ...
      $query =mysqli_num_rows($sql);
      $query2=mysqli_num_rows($sql2);
      $sql3 =mysqli_query($connect, "SELECT * FROM penduduk WHERE rw='006'");
      $query3 =mysqli_num_rows($sql3);?>
      <tr><td>Jumlah Laki-laki Pada RW 006 : <b> <?php echo $query; ?></b></td>
      <td>Jumlah Perempuan Pada RW 006 : <b> <?php echo $query2; ?></b></td>
      <td>Jumlah Penduduk Pada RW 006 : <b> <?php echo $query3; ?></b></td>
      ...
      $query =mysqli_num_rows($sql);
      $query2=mysqli_num_rows($sql2);
      $sql3 =mysqli_query($connect, "SELECT * FROM penduduk WHERE rw='007'");
      $query3 =mysqli_num_rows($sql3);
      ?>
      <tr><td>Jumlah Laki-laki Pada RW 007 : <b> <?php echo $query; ?></b></td>
      <td>Jumlah Perempuan Pada RW 007 : <b> <?php echo $query2; ?></b></td>
      <td>Jumlah Penduduk Pada RW 007 : <b> <?php echo $query3; ?></b></td>
     </tr>
      <?php
      ...
      $query =mysqli_num_rows($sql);
      $query2=mysqli_num_rows($sql2);
      $sql3 =mysqli_query($connect, "SELECT * FROM penduduk WHERE rw='008'");
      $query3 =mysqli_num_rows($sql3);?>
      <tr><td>Jumlah Laki-laki Pada RW 008 : <b> <?php echo $query; ?></b></td>
      <td>Jumlah Perempuan Pada RW 008 : <b> <?php echo $query2; ?></b></td>
      <td>Jumlah Penduduk Pada RW 008 : <b> <?php echo $query3; ?></b></td>
      ...
      $query =mysqli_num_rows($sql);
      $query2=mysqli_num_rows($sql2);
      $sql3 =mysqli_query($connect, "SELECT * FROM penduduk WHERE rw='009'");
      $query3 =mysqli_num_rows($sql3);
      ?>
      <tr><td>Jumlah Laki-laki Pada RW 009 : <b> <?php echo $query; ?></b></td>
      <td>Jumlah Perempuan Pada RW 009 : <b> <?php echo $query2; ?></b></td>
      <td>Jumlah Penduduk Pada RW 009 : <b> <?php echo $query3; ?></b></td>
    </tr>
      <?php
      ...
      $query =mysqli_num_rows($sql);
      $query2=mysqli_num_rows($sql2);
      $sql3 =mysqli_query($connect, "SELECT * FROM penduduk WHERE rw='010'");
      $query3 =mysqli_num_rows($sql3);
      ?>
      <tr><td>Jumlah Laki-laki Pada RW 010 : <b> <?php echo $query; ?></b></td>
        <td>Jumlah Perempuan Pada RW 010 : <b> <?php echo $query2; ?></b></td>
        <td>Jumlah Penduduk Pada RW 010 : <b> <?php echo $query3; ?></b></td>
      <br>
      <tr>
