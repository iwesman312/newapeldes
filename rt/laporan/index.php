        ...
        <?php
          if(isset($_GET['filter']) && ! empty($_GET['filter'])){
            ...
            if($filter == '1'){
              ...
              UNION SELECT penduduk.nama, penduduk.dusun, penduduk.rt, penduduk.rw, surat_ktp.no_surat, surat_ktp.tanggal_surat, surat_ktp.jenis_surat FROM penduduk LEFT JOIN surat_ktp ON surat_ktp.nik = penduduk.nik WHERE surat_ktp.status_surat='selesai' ORDER BY tanggal_surat";
              ...
              UNION SELECT penduduk.nama, penduduk.dusun, penduduk.rw, penduduk.rt, surat_ktp.no_surat, surat_ktp.tanggal_surat, surat_ktp.jenis_surat FROM penduduk LEFT JOIN surat_ktp ON surat_ktp.nik = penduduk.nik WHERE surat_ktp.status_surat='selesai' AND DATE(surat_ktp.tanggal_surat)='{$_GET['tanggal']}' ORDER BY tanggal_surat";
            }else if($filter == '3'){
              ...
              UNION SELECT penduduk.nama, penduduk.dusun, penduduk.rw, penduduk.rt, surat_ktp.no_surat, surat_ktp.tanggal_surat, surat_ktp.jenis_surat FROM penduduk LEFT JOIN surat_ktp ON surat_ktp.nik = penduduk.nik WHERE surat_ktp.status_surat='selesai' AND MONTH(surat_ktp.tanggal_surat)='{$_GET['bulan']}' AND YEAR(surat_ktp.tanggal_surat)='{$_GET['tahun']}' ORDER BY tanggal_surat";
            }else if($filter == '4'){
              ...
              UNION SELECT penduduk.nama, penduduk.dusun, penduduk.rw, penduduk.rt, surat_pengantar_skck.no_surat, surat_pengantar_skck.tanggal_surat, surat_pengantar_skck.jenis_surat FROM penduduk LEFT JOIN surat_pengantar_skck ON surat_pengantar_skck.nik = penduduk.nik WHERE surat_pengantar_skck.status_surat='selesai' AND YEAR(surat_pengantar_skck.tanggal_surat)='{$_GET['tahun']}' 
               UNION SELECT penduduk.nama, penduduk.dusun, penduduk.rw, penduduk.rt, surat_ktp.no_surat, surat_ktp.tanggal_surat, surat_ktp.jenis_surat FROM penduduk LEFT JOIN surat_ktp ON surat_ktp.nik = penduduk.nik WHERE surat_ktp.status_surat='selesai' AND YEAR(surat_ktp.tanggal_surat)='{$_GET['tahun']}'ORDER BY tanggal_surat";
            }
          }else{
            $query = "SELECT penduduk.nama, penduduk.dusun, penduduk.rt, penduduk.rw, surat_keterangan.no_surat, surat_keterangan.tanggal_surat, surat_keterangan.jenis_surat FROM penduduk LEFT JOIN surat_keterangan ON surat_keterangan.nik = penduduk.nik WHERE surat_keterangan.status_surat='selesai'
            UNION SELECT penduduk.nama, penduduk.dusun, penduduk.rt, penduduk.rw, surat_keterangan_berkelakuan_baik.no_surat, surat_keterangan_berkelakuan_baik.tanggal_surat, surat_keterangan_berkelakuan_baik.jenis_surat FROM penduduk LEFT JOIN surat_keterangan_berkelakuan_baik ON surat_keterangan_berkelakuan_baik.nik = penduduk.nik WHERE surat_keterangan_berkelakuan_baik.status_surat='selesai' 
