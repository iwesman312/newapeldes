    ...
    <div class="row">
      <div class="col-md-12">
          ...
          <?php 
            if(isset($_GET['pesan'])){
              if($_GET['pesan']=="gagal-menambah"){
                echo "<div class='alert alert-danger'><center>Anda tidak bisa menambah data. Username tersebut sudah digunakan.</center></div>";
              }
        ...
        <?php 
          if(isset($_SESSION['lvl']) && ($_SESSION['lvl'] == 'Administrator')){
        ?>
        <a class="btn btn-success btn-md" href='tambah-user.php'><i class="fa fa-user-plus"></i> Tambah User</a>
        <!-- <div class="btn-group">
        ...
        <table class="table table-striped table-bordered table-responsive" id="data-table" width="100%" cellspacing="0">
          ...
          <tbody>
            <?php
              ...
              $no = 1;
              $qTampil = mysqli_query($connect, "SELECT * FROM login");
            ...
            <tr>
              ...
              <td style="text-transform: capitalize;"><?php echo $row['level']; ?></td>
              <?php 
                if(isset($_SESSION['lvl']) && ($_SESSION['lvl'] == 'Administrator')){
              ?>
              <td>
                <!-- <a class="btn btn-success btn-sm" href='edit-penduduk.php?id=<?php echo $row['id']; ?>'><i class="fa fa-edit"></i></a> -->
                <a class="btn btn-danger btn-sm" href='hapus-user.php?id=<?php echo $row['id']; ?>' onclick="return confirm('Apakah Anda yakin ingin menghapus data ini?')"><i class="fa fa-trash"></i></a>
              </td>
              <?php  
                } else {
