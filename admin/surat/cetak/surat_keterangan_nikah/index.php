<?php 
	include ('../../permintaan_surat/konfirmasi/part/akses.php');
  	...
  	$id = $_GET['id'];
  	$qCek = mysqli_query($connect,"SELECT penduduk.*, surat_keterangan_nikah.* FROM penduduk LEFT JOIN surat_keterangan_nikah ON surat_keterangan_nikah.nik = penduduk.nik WHERE surat_keterangan_nikah.id_sk='$id'");
  	while($row = mysqli_fetch_array($qCek)){
        ...
        foreach($qTampilDesa as $rows){
			...
			$id_pejabat_desa = $row['id_pejabat_desa'];
		  	$qCekPejabatDesa = mysqli_query($connect,"SELECT pejabat_desa.jabatan, pejabat_desa.nama_pejabat_desa FROM pejabat_desa LEFT JOIN surat_keterangan_nikah ON surat_keterangan_nikah.id_pejabat_desa = pejabat_desa.id_pejabat_desa WHERE surat_keterangan_nikah.id_pejabat_desa = '$id_pejabat_desa' AND surat_keterangan_nikah.id_sk='$id'");
