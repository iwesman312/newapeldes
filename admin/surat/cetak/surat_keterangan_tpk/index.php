<?php 
	include ('../../permintaan_surat/konfirmasi/part/akses.php');
  	...
  	$id = $_GET['id'];
  	$qCek = mysqli_query($connect,"SELECT penduduk.*, surat_keterangan_tpk.* FROM penduduk LEFT JOIN surat_keterangan_tpk ON surat_keterangan_tpk.nik = penduduk.nik WHERE surat_keterangan_tpk.id_sk='$id'");
  	while($row = mysqli_fetch_array($qCek)){
        ...
        foreach($qTampilDesa as $rows){
			...
			$id_pejabat_desa = $row['id_pejabat_desa'];
		  	$qCekPejabatDesa = mysqli_query($connect,"SELECT pejabat_desa.jabatan, pejabat_desa.nama_pejabat_desa FROM pejabat_desa LEFT JOIN surat_keterangan_tpk ON surat_keterangan_tpk.id_pejabat_desa = pejabat_desa.id_pejabat_desa WHERE surat_keterangan_tpk.id_pejabat_desa = '$id_pejabat_desa' AND surat_keterangan_tpk.id_sk='$id'");
...
<div>
	...
	<div id="isi3">
		<table width="100%">
			<tr>
				<td class="indentasi">Yang bertanda tangan di bawah ini, <a style="text-transform: capitalize;">Kepala Desa <?php echo $rows['nama_desa']; ?>, Kecamatan <?php echo $rows['kecamatan']; ?>, <?php echo $rows['kota']; ?></a>, menerangkan bahwa :
				</td>
			</tr>
		</table>
		<br><br>
		...
		<table width="100%">
			<tr>
				<td class="indentasi">Benar Nama tersebut adalah Warga desa kami yang berdomisili dialamat tersebut diatas, dan pada saat ini yang bersangkutan tidak mempunyai pekerjaan atau tidak bekerja.</td>
			</tr>
		</table><br>
		<table width="100%">
			<tr>
				<td class="indentasi">Surat keterangan ini untuk <a style="text-transform: capitalize;"><u><b><?php echo $row['keperluan']; ?>.</a></u></b></td>
			</tr>
		</table><br>
		<table width="100%">
			<tr>
				<td class="indentasi">Demikian surat keterangan ini dibuat dengan sebenarnya agar yang berkepentingan menjadi malum dan untuk diketahui sebagaimana mestinya.</td>
			</tr>
		</table>
	</div>
	<br>
