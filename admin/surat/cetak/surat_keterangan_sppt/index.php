<?php 
	include ('../../permintaan_surat/konfirmasi/part/akses.php');
  	...
  	$id = $_GET['id'];
  	$qCek = mysqli_query($connect,"SELECT penduduk.*, surat_keterangan_sppt.* FROM penduduk LEFT JOIN surat_keterangan_sppt ON surat_keterangan_sppt.nik = penduduk.nik WHERE surat_keterangan_sppt.id_sk='$id'");
  	while($row = mysqli_fetch_array($qCek)){
        ...
        foreach($qTampilDesa as $rows){
			...
			$id_pejabat_desa = $row['id_pejabat_desa'];
		  	$qCekPejabatDesa = mysqli_query($connect,"SELECT pejabat_desa.jabatan, pejabat_desa.nama_pejabat_desa FROM pejabat_desa LEFT JOIN surat_keterangan_sppt ON surat_keterangan_sppt.id_pejabat_desa = pejabat_desa.id_pejabat_desa WHERE surat_keterangan_sppt.id_pejabat_desa = '$id_pejabat_desa' AND surat_keterangan_sppt.id_sk='$id'");
...
<div>
	...
	<div id="isi3">
		...
		<table width="100%" style="text-transform: capitalize;">
			...
			<tr>
				<td class="indentasi">Luas Bumi</td>
				<td>:</td>
			...
			<tr>
				<td class="indentasi">Alamat Objek Pajak</td>
				<td>:</td>
		...
		<table width="100%">
			<tr>
				<td class="indentasi">Bahwa benar nama SPPT tersebut diatas sedang di proses untuk balik nama pada:</td>
			</tr>
		</table><br>
		<table width="100%" style="text-transform: capitalize;">
			<tr>
