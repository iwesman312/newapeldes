...
<div>
	...
	<div id="isi3">
		<table width="100%">
			<tr>
				<td class="indentasi">Yang bertanda tangan di bawah ini, <a style="text-transform: capitalize;"><?php echo $rowss['jabatan'] . " " . $rows['nama_desa']; ?>, Kecamatan <?php echo $rows['kecamatan']; ?>, <?php echo $rows['kota']; ?></a>, Dengan ini menerangkan :
				</td>
			</tr>
		</table>
		<br><br>
		...
		<table width="100%">
			<tr>
				<td class="indentasi">Benar nama tersebut diatas pada saat ini berdomisili dialamat tersebut diatas, dan mempunyai usaha :</td>
			</tr>
		</table><br><br>
		<table width="100%" style="text-transform: capitalize;">
			<tr>
				<td width="30%" class="indentasi">Dibidang</td>
				<td width="2%">:</td>
				<td width="68%"><?php echo $row['usaha']; ?></td>
			</tr>
			<tr>
				<td width="30%" class="indentasi">Yang berlokasi di</td>
				<td width="2%">:</td>
				<td width="68%"><?php echo $row['alamat_usaha']; ?></td>
			</tr>
		...
		<table width="100%">
			<tr>
				<td class="indentasi">Demikian surat keterangan ini dibuat dengan sebenarnya agar yang berkepentingan menjadi maklum.
				</td>
			</tr>
		</table>
	</div>
