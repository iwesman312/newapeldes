<?php 
  ...
  $id = $_GET['id'];
  $qCek = mysqli_query($connect,"SELECT penduduk.*, surat_keterangan_tpk.* FROM penduduk LEFT JOIN surat_keterangan_tpk ON surat_keterangan_tpk.nik = penduduk.nik WHERE surat_keterangan_tpk.id_sk='$id' AND surat_keterangan_tpk.FLAG_SMS !='Y'");
