<?php 
  ...
  $id = $_GET['id'];
  $qCek = mysqli_query($connect,"SELECT penduduk.*, surat_keterangan_kematian.* FROM penduduk LEFT JOIN surat_keterangan_kematian ON surat_keterangan_kematian.nik = penduduk.nik WHERE surat_keterangan_kematian.id_sk='$id' AND surat_keterangan_kematian.FLAG_SMS !='Y'");
            ...
            <form class="form-horizontal" method="post" action="update-konfirmasi.php">
              ...
              <div class="row">
                <div class="col-md-6">
                  <div class="box-body">
                    <div class="form-group">
                      <label class="col-sm-3 control-label">Surat Pengantar RT</label>
                      <div class="col-sm-9">
                    ...
                    <div class="form-group">
                      ...
                      <div class="col-sm-9">
                        <input type="text" name="fdate" style="text-transform: capitalize;" value="<?php echo $row['date_death']; ?>" class="form-control" readonly>
                      </div>
                    </div>
                    <div class="form-group">
                      <label class="col-sm-3 control-label">Tempat Meninggal</label>
                      <div class="col-sm-9">
                        <input type="text" name="flocation" style="text-transform: capitalize;" value="<?php echo $row['location_death']; ?>" class="form-control" readonly>
                      </div>
                    </div>
                    <div class="form-group">
