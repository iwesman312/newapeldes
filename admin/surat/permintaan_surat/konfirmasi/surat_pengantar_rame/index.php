            ...
            <form class="form-horizontal" method="post" action="update-konfirmasi.php">
              ...
              <div class="row">
                <div class="col-md-6">
                  <div class="box-body">
                    <div class="form-group">
                      <label class="col-sm-3 control-label">Jenis Keramaian</label>
                      <div class="col-sm-9">
                ...
                <div class="col-md-6">
                  <div class="box-body">
                    ...
                    <div class="form-group">
                      ...
                      <div class="col-sm-9">
                        <input type="text" name="fbukti_kk" style="text-transform: uppercase;" value="<?php echo $row['bukti_ktp']; ?>" class="form-control" readonly>
                      </div>
                    </div>
                  </div>
