<?php
	...
	$qUpdate 	= "UPDATE surat_ktp SET no_surat='$no_surat', id_pejabat_desa='$id_pejabat_desa', status_surat='$status_surat' WHERE id_sktp='$id'";
	$update 	= mysqli_query($connect, $qUpdate);

	if ($update) {
		echo "Update successful for ID: $id<br>"; // Debugging output
		$sqlChk = "SELECT FLAG_SMS FROM surat_ktp WHERE id_sktp = '$id'";
