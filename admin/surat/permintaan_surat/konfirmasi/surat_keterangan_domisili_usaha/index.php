<?php 
  ...
  $id = $_GET['id'];
  $qCek = mysqli_query($connect,"SELECT * from surat_domisili_usaha WHERE surat_domisili_usaha.id_skdtt='$id'");
              ...
              <div class="row">
                <div class="col-md-6">
                  ...
                  <div class="form-group">
                    ...
                    <div class="form-group">
                      <label class="col-sm-3 control-label">Akta Pendirian Usaha</label>
                      <div class="col-sm-9">
