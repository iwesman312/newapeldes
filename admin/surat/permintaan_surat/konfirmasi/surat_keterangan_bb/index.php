<?php 
  ...
  $id = $_GET['id'];
  $qCek = mysqli_query($connect,"SELECT penduduk.*, surat_keterangan_bb.* FROM penduduk LEFT JOIN surat_keterangan_bb ON surat_keterangan_bb.nik = penduduk.nik WHERE surat_keterangan_bb.id_sk='$id' AND surat_keterangan_bb.FLAG_SMS !='Y'");
            ...
            <form class="form-horizontal" method="post" action="update-konfirmasi.php">
              ...
              <div class="row">
                <div class="col-md-6">
                  <div class="box-body">
                    <div class="form-group">
                      <label class="col-sm-3 control-label">Perbedaan ?</label>
                      <div class="col-sm-9">
                        <input type="text" name="fkeperluan" style="text-transform: capitalize;" value="<?php echo $row['keperluan']; ?>" class="form-control" readonly>
                      </div>
                    </div>
                    <div class="form-group">
                      <label class="col-sm-3 control-label">Dokumen 1</label>
                      <div class="col-sm-9">
                        <input type="text" name="fkeperluan2" style="text-transform: capitalize;" value="<?php echo $row['keperluan2']; ?>" class="form-control" readonly>
                      </div>
                    </div>
                    <div class="form-group">
                      <label class="col-sm-3 control-label">Dokumen 2</label>
                      <div class="col-sm-9">
                        <input type="text" name="fkeperluan3" style="text-transform: capitalize;" value="<?php echo $row['keperluan3']; ?>" class="form-control" readonly>
                      </div>
                    </div>
                    <div class="form-group">
                      <label class="col-sm-3 control-label">Dokumen 3</label>
                      <div class="col-sm-9">
                        <input type="text" name="fkeperluan4" style="text-transform: capitalize;" value="<?php echo $row['keperluan4']; ?>" class="form-control" readonly>
                      </div>
                    </div>
                    <div class="form-group">
                      <label class="col-sm-3 control-label">Dokumen 4</label>
                      <div class="col-sm-9">
                        <input type="text" name="fkeperluan5" style="text-transform: capitalize;" value="<?php echo $row['keperluan5']; ?>" class="form-control" readonly>
                      </div>
                    </div>
                    <div class="form-group">
                      <label class="col-sm-3 control-label">Yang berbeda?</label>
                      <div class="col-sm-9">
                        <input type="text" name="falamatdomisili" style="text-transform: capitalize;" value="<?php echo $row['domisil']; ?>" class="form-control" readonly>
                      </div>
                    </div>
                    <div class="form-group">
                      <label class="col-sm-3 control-label">Berbeda di?</label>
                      <div class="col-sm-9">
                        <input type="text" name="fmeninggalloc" style="text-transform: capitalize;" value="<?php echo $row['location_death']; ?>" class="form-control" readonly>
                      </div>
                    </div>
                    <div class="form-group">
                      <label class="col-sm-3 control-label">Seharusnya?</label>
                      <div class="col-sm-9">
                        <input type="text" name="fmeninggaldate" style="text-transform: capitalize;" value="<?php echo $row['date_death']; ?>" class="form-control" readonly>
                      </div>
                    </div>
                    <div class="form-group">
