<?php 
  ...
  $id = $_GET['id'];
  $qCek = mysqli_query($connect,"SELECT penduduk.*, surat_keterangan_tm.* FROM penduduk LEFT JOIN surat_keterangan_tm ON surat_keterangan_tm.nik = penduduk.nik WHERE surat_keterangan_tm.id_sk='$id' AND surat_keterangan_tm.FLAG_SMS !='Y'");
