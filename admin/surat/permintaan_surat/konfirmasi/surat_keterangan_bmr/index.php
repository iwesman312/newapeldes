<?php 
  ...
  $id = $_GET['id'];
  $qCek = mysqli_query($connect,"SELECT penduduk.*, surat_keterangan_bmr.* FROM penduduk LEFT JOIN surat_keterangan_bmr ON surat_keterangan_bmr.nik = penduduk.nik WHERE surat_keterangan_bmr.id_sk='$id' AND surat_keterangan_bmr.FLAG_SMS !='Y'");
