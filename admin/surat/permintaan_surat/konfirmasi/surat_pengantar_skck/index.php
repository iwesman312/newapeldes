            ...
            <form class="form-horizontal" method="post" action="update-konfirmasi.php">
                ...
                <div class="col-md-6">
                  <div class="box-body">
                    ...
                    <div class="form-group">
                      ...
                      <div class="col-sm-9">
                        <input type="text" name="fkewarganegaraan" style="text-transform: uppercase;" value="<?php echo $row['keperluan']; ?>" class="form-control" readonly>
                      </div>
                    </div>
                    <br><br>
                    <!-- <div class="form-group">
              ...
              <div class="row">
                ...
                <!-- <div class="col-md-6">
                  ...
                  <div class="box-body">
                    <div class="form-group">
                      <label class="col-sm-3 control-label">Akta Kelahiran</label>
                      <div class="col-sm-9">
                        <input type="text" name="fakta" style="text-transform: uppercase;" value="<?php echo $row['akta']; ?>" class="form-control" readonly>
                      </div>
                    </div>
                  </div> -->
