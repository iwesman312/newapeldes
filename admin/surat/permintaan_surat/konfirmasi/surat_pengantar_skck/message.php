...
$no_hp = isset($_POST['fbukti_ktp']) ? mysqli_real_escape_string($connect, $_POST['fbukti_ktp']) : '';
...
if (!file_exists($flagFile)) {
    ...
    if (isset($response_data['status']) && $response_data['status'] == 'success') {
        ...
        $SQL = "UPDATE surat_pengantar_skck SET FLAG_SMS = 'Y' WHERE id_sps = '$id' AND FLAG_SMS != 'Y'";
