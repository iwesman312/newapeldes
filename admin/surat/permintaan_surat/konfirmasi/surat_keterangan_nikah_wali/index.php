<?php 
  ...
  $id = $_GET['id'];
  $qCek = mysqli_query($connect, "SELECT penduduk.*, surat_keterangan_nikah_wali.* 
                                  FROM penduduk 
                                  LEFT JOIN surat_keterangan_nikah_wali 
                                  ON surat_keterangan_nikah_wali.nik = penduduk.nik 
                                  WHERE surat_keterangan_nikah_wali.custom_id='$id' 
                                  AND surat_keterangan_nikah_wali.FLAG_SMS != 'Y'");
              ...
              <div class="row">
                <div class="col-md-6">
                  <div class="box-body">
                    ...
                    <div>
                      <input type="hidden" name="id" value="<?php echo $row['custom_id']; ?>" class="form-control">
                    </div>
                  </div>
                </div>
                <div class="col-md-6">
              ...
              <div class="row">
                <div class="col-md-6">
                  <div class="box-body">
                    ...
                    <div>
                      <input type="hidden" name="id" value="<?php echo $rowsss['custom_id']; ?>" class="form-control">
                    </div>
                  </div>
                </div>
                <div class="col-md-6">
              ...
              <div class="row">
                <div class="col-md-6">
                  <div class="box-body">
                    ...
                    <div>
                      <input type="hidden" name="id" value="<?php echo $rowss['custom_id']; ?>" class="form-control">
                    </div>
                  </div>
                </div>
                <div class="col-md-6">
