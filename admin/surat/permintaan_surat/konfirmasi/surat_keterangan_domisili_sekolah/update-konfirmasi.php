<?php
	...
	$qUpdate 	= "UPDATE surat_domisili_sekolah SET no_surat='$no_surat', id_pejabat_desa='$id_pejabat_desa', status_surat='$status_surat' WHERE id_skdtt='$id'";
	$update 	= mysqli_query($connect, $qUpdate);

	if ($update) {
		echo "Update successful for ID: $id<br>"; // Debugging output
		$sqlChk = "SELECT FLAG_SMS FROM surat_domisili_sekolah WHERE id_skdtt = '$id'";
