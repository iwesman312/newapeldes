  ...
  <?php
    ...
    if(isset($_GET['filter']) && ! empty($_GET['filter'])){
      ...
      if($filter == '1'){
        echo '
          <div class="header">
            <div align="center" style="font-size: 14pt;"><b>Laporan Surat Administrasi Desa - Surat Keluar Desa </b></div>
            <hr>
          </div><br>
        ';
        ...
        echo '
          <div class="header">
            <div align="center" style="font-size: 12pt;"><b>Laporan Surat Administrasi Desa - Surat Keluar Desa </b></div>
