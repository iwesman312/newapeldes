...
<div class="content-wrapper">
  ...
  <section class="content">      
    <div class="row">
      <div class="col-md-12">
      <form action="import-penduduk.php" method="POST" enctype="multipart/form-data">
    <label for="datapenduduk">Unggah File Excel:</label>
    <input type="file" name="datapenduduk" id="datapenduduk" accept=".csv" required>
                ...
                <div class="col-md-6">
                  <div class="box-body">
                    <div class="form-group">
                      ...
                      <div class="col-sm-8">
                        <input type="text" name="fnik" maxlength="16" onkeypress="return hanyaAngka(event)" class="form-control" placeholder="NIK">
                        <script>
