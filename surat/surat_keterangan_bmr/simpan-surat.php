...
if (isset($_POST['submit'])) {
    $jenis_surat = "Surat Keterangan Belum Memiliki Rumah";
    $nik = $_POST['fnik'];
    ...
    $qTambahSurat = "INSERT INTO surat_keterangan_bmr (jenis_surat, nik, keperluan, status_surat, id_profil_desa, no_hp) 
    ...
    if ($TambahSurat) {
        ...
        $url = "http://localhost/desa/surat/surat_keterangan_bmr/message.php?id=$id_sk"; // Sesuaikan dengan URL message.php di server Anda
        ...
        header("location:../surat_keterangan_bmr/message.php?id=$id_sk");
        exit();
    } else {
