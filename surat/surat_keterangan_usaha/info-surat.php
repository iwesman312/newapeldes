				...
				<div class="card">
					...
					<form method="post" action="simpan-surat.php">
						...
						<div class="row">
						  	<div class="col-sm-12">
						  		<div class="form-group">
						           	<label class="col-sm-12" style="font-weight: 500;">Bidang Usaha</label>
						           	<div class="col-sm-12">
						               	<input type="text" name="fusaha" class="form-control" style="text-transform: capitalize;" placeholder="Masukkan Bidang Usaha Anda" required>
						           	</div>
						        </div>
						        <div class="form-group">
								...
								<div class="form-group">
						           	...
						           	<div class="col-sm-12">
						               	<input type="number" name="fno_hp" class="form-control" style="text-transform: capitalize;" placeholder="Masukkan Keperluan Surat" required>
						           	</div>
						        </div>
						  	</div>
						</div>
