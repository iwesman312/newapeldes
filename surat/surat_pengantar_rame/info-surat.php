			...
			<div class="col-md-12">
				<div class="card">
					...
					<form method="post" action="simpan-surat.php">
						...
						<br>
						<h6 class="container-fluid" align="right"><i class="fas fa-edit"></i>Nomor WA Pemohon Surat</h6><hr width="97%">
						<div class="row">
						  	<div class="col-sm-6">
						      	<div class="form-group">
						           	<label class="col-sm-12" style="font-weight: 500;">No WA Pemohon</label>
						           	<div class="col-sm-12">
				                        <script>
						...
						<br>
						<h6 class="container-fluid" align="right"><i class="fas fa-edit"></i> Formulir Keramaian</h6><hr width="97%">
						<div class="row">
						  	<div class="col-sm-6">
						      	<div class="form-group">
						           	...
						           	<div class="col-sm-12">
			                        	<select name="fjenis_hajat" class="form-control" required>
			                          		<option value="">-- Jenis Keramaian --</option>
											  ...
											  <option value="Pawai Kemerdekaan">Pawai Kemerdekaan</option>
											  <option value="Perayaan Hari Raya">Perayaan Hari Raya</option>
			                        	</select>
			                      	</div>
						        </div>
						  	</div>
							  ...
							  <div class="col-sm-6">
						      	<div class="form-group">
						           	<label class="col-sm-12" style="font-weight: 500;">Pukul/Jam</label>
						           	<div class="col-sm-12">
						               	<input type="text" name="fpemilik" class="form-control" style="text-transform: capitalize;" placeholder="Masukkan Jenis Hiburan" required>
						           	</div>
						        </div>
						  	</div>
						  	<div class="col-sm-6">
