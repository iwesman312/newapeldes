...
if (isset($_POST['submit'])) {
    ...
    $qTambahSurat = "INSERT INTO surat_keterangan (jenis_surat, nik, keperluan, status_surat, id_profil_desa, no_hp) 
    ...
    if ($TambahSurat) {
        ...
        $url = "http://localhost/desa/surat/surat_keterangan/message.php?id=$id_sk"; // Sesuaikan dengan URL message.php di server Anda
        ...
        header("location:../surat_keterangan/message.php?id=$id_sk");
        exit();
    } else {
