				...
				<div class="card">
					...
					<form method="post" action="simpan-surat.php">
						...
						<div class="row">
						  	<div class="col-sm-12">
						      	<div class="form-group">
						           	<label class="col-sm-12" style="font-weight: 500;">Surat Pengantar RT</label>
						           	<div class="col-sm-12">
						               	<input type="text" name="fkeperluan" class="form-control" style="text-transform: capitalize;" placeholder="Masukkan Nomor Surat Pengantar RT" required>
						           	</div>
									   <div class="form-group">
						           	<label class="col-sm-12" style="font-weight: 500;">Domisili Saat ini</label>
									   <div class="col-sm-12">
						               	<input type="text" name="falamatdomisili" class="form-control" style="text-transform: capitalize;" placeholder="Masukan Domisili Anda" required>
						           	</div>
									   <div class="form-group">
						           	<label class="col-sm-12" style="font-weight: 500;">Meninggal Dunia Pada</label>
									<div class="col-sm-12">
						               	<input type="text" name="fmeninggaldate" class="form-control" style="text-transform: capitalize;" placeholder="Masukan Tanggal Bulan dan Tahun" required>
						           	</div>
									   <div class="form-group">
						           	<label class="col-sm-12" style="font-weight: 500;">Meninggal Dunia Di</label>
									<div class="col-sm-12">
						               	<input type="text" name="fmeninggalloc" class="form-control" style="text-transform: capitalize;" placeholder="Masukan Tempat meninggal" required>
						           	</div>
						           	<div class="form-group">
