...
if (isset($_POST['submit'])){
    ...
    $qTambahSurat = "INSERT INTO surat_domisili_usaha (jenis_surat, nik, alamat2, tanggal, status_bangunan, status_surat, id_profil_desa, nama, alamat, kk, bangunan, pekerjaan, warganegara, agama, jenis_kelamin, luas, no_hp, namau, akta, jenis, pbb, worker, pic, lampiran) VALUES('$jenis_surat', '$nik', '$alamat2','$tanggal','$sejak','$status_surat', '$id_profil_desa', '$nama', '$alamat','$kk','$passport','$pekerjaan','$warganegara','$agama','$jenis_kelamin','$tujuan', '$wa','$namau','$akta','$jenis','$pbb','$worker','$pic','$lampiran')";
    ...
    if ($TambahSurat) {
        ...
        $url = "http://localhost/desa/surat/surat_keterangan_domisili_usaha/message.php?id=$id_sk"; // Sesuaikan dengan URL message.php di server Anda
        ...
        header("location:../surat_keterangan_domisili_usaha/message.php?id=$id_sk");
        exit();
    } else {
