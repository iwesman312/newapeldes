						...
						<div class="row">
						  	<div class="col-sm-12">
						      	<div class="form-group">
						           	...
						           	<div class="col-sm-12">
						               	<input type="text" name="fnama_wp" class="form-control" style="text-transform: capitalize;" placeholder="Masukkan Nama Wajib Pajak" required>
						           	</div>
									   <div class="form-group">
						           	<label class="col-sm-12" style="font-weight: 500;">Alamat Wajib pajak</label>
						           	<div class="col-sm-12">
						               	<input type="text" name="falamat_wp" class="form-control" style="text-transform: capitalize;" placeholder="Masukkan Alamat Wajib Pajak" required>
						           	</div>
									   <div class="form-group">
						           	<label class="col-sm-12" style="font-weight: 500;">Luas Bumi</label>
						           	<div class="col-sm-12">
						               	<input type="text" name="fluas_wp" class="form-control" style="text-transform: capitalize;" placeholder="Masukkan LUAS BUMI" required>
						           	</div>
									   <div class="form-group">
						           	<label class="col-sm-12" style="font-weight: 500;">NOP</label>
						           	<div class="col-sm-12">
						               	<input type="number" name="fnop_wp" class="form-control" style="text-transform: capitalize;" placeholder="Masukkan NOP" required>
						           	</div>
									   <div class="form-group">
						           	<label class="col-sm-12" style="font-weight: 500;">Alamat Objek Pajak</label>
						           	<div class="col-sm-12">
						               	<input type="text" name="falamat_owp" class="form-control" style="text-transform: capitalize;" placeholder="Masukkan Alamat Objek Pajak" required>
						           	</div>
						           	<div class="form-group">
