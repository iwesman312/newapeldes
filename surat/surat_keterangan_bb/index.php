            ...
            <div class="card-body">
                <form action="info-surat.php" method="post"> 
                  <?php 
                    if(isset($_GET['pesan'])){
                      if($_GET['pesan']=="gagal"){
                        echo "<div class='alert alert-danger'><center>NIK Anda tidak terdaftar!</center></div>";
                      }
                    }
                  ?>
                  <label style="font-weight: 700;"></i>Kepala Desa Jonggol</i></label>
                  <img src="../../assets/img/kades.jpg"><hr>
                  <!--<label style="font-weight: 700;"></i>Bapak M. Irfan Syahrizal</i></label>-->
