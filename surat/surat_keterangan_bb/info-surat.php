				...
				<div class="card">
					...
					<form method="post" action="simpan-surat.php">
						...
						<div class="row">
						  	<div class="col-sm-12">
						      	<div class="form-group">
						           	<label class="col-sm-12" style="font-weight: 500;">Perbedaan? (masukan hal yang berbeda. Contoh: tanggal Lahir)</label>
						           	<div class="col-sm-12">
						               	<input type="text" name="fkeperluan" class="form-control" style="text-transform: capitalize;" placeholder="Wajib di isi (misal KK)" required>
						           	</div>
									   <div class="form-group">
						           	<label class="col-sm-12" style="font-weight: 500;">Dokumen 1</label>
						           	<div class="col-sm-12">
						               	<input type="text" name="fkeperluan2" class="form-control" style="text-transform: capitalize;" placeholder="Wajib di isi (misal KK)" required>
						           	</div>
									   <div class="form-group">
						           	<label class="col-sm-12" style="font-weight: 500;">Dokumen 2</label>
						           	<div class="col-sm-12">
						               	<input type="text" name="fkeperluan3" class="form-control" style="text-transform: capitalize;" placeholder="Wajib di isi (misal KK)"required>
						           	</div>
									   <div class="form-group">
						           	<label class="col-sm-12" style="font-weight: 500;">Dokumen 3</label>
						           	<div class="col-sm-12">
						               	<input type="text" name="fkeperluan4" class="form-control" style="text-transform: capitalize;" placeholder="Wajib di isi jika lebih dari 2 document">
						           	</div>
									   <div class="form-group">
						           	<label class="col-sm-12" style="font-weight: 500;">Dokumen 4</label>
						           	<div class="col-sm-12">
						               	<input type="text" name="fkeperluan5" class="form-control" style="text-transform: capitalize;" placeholder="Wajib di isi jika lebih dari 2 document">
						           	</div>
									   <div class="form-group">
						           	<label class="col-sm-12" style="font-weight: 500;">Yang berbeda?</label>
									   <div class="col-sm-12">
						               	<input type="text" name="falamatdomisili" class="form-control" style="text-transform: capitalize;" placeholder="Masukan Hal yang berbeda/Salah" required>
						           	</div>
									   <div class="form-group">
						           	<label class="col-sm-12" style="font-weight: 500;">Berbeda di?</label>
									   <div class="col-sm-12">
						               	<input type="text" name="fmeninggalloc" class="form-control" style="text-transform: capitalize;" placeholder="Masukan dokumen yang salah" required>
						           	</div>
									   <div class="form-group">
						           	<label class="col-sm-12" style="font-weight: 500;">Seharusnya?</label>
									<div class="col-sm-12">
						               	<input type="text" name="fmeninggaldate" class="form-control" style="text-transform: capitalize;" placeholder="Masukan data yang seharusnya" required>
						           	</div>
						           	<div class="form-group">
