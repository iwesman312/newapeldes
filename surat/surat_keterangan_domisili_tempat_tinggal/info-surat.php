                ...
                <div class="card">
                    ...
                    <form method="post" action="simpan-surat.php">
                        ...
                        <div class="row">
                            <div class="col-sm-12">
                                <div class="form-group">
                                    <label class="col-sm-12" style="font-weight: 500;">Passport NOMOR</label>
                                    <div class="col-sm-12">
                                        <input type="text" name="fpassport" class="form-control" placeholder="Masukkan Nomor Passport Anda">
                                    </div>
                                </div>
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-sm-12">
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-12">
                                        <input type="date" name="fsejak" class="form-control" required>
                                    </div>
                                </div>
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-sm-12">
                                <div class="form-group">
                                    <label class="col-sm-12" style="font-weight: 500;">Maksud/Tujuan</label>
                                    <div class="col-sm-12">
