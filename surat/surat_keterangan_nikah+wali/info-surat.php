<?php
	...
	$qCekNik = mysqli_query($connect,"SELECT * FROM penduduk WHERE nik = '$nik' AND jenis_kelamin = 'PEREMPUAN'");
                    ...
                    <h6 class="container-fluid" align="right"><i class="fas fa-user"></i> Informasi Orang Tua</h6><hr width="97%">
                      ...
                      <h6 class="container-fluid" align="right"><i class="fas fa-user"></i> Informasi Orang Tua</h6><hr width="97%">
						...
						<div class="row">
						  	<div class="col-sm-6">
						      	<div class="form-group">
						           	<label class="col-sm-12" style="font-weight: 500;">Nama Wali</label>
						               	<input type="text" name="fwali" class="form-control" placeholder="Nama Wali Nikah" required>
						           	</div>
						        </div>
						<br>
