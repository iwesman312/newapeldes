...
$sql = "SELECT nik, id_sk FROM surat_keterangan_nikah_wali WHERE id_sk = '$id'";
...
<div class="container">
    ...
    if (!file_exists($flagFile)) {
        ...
        $curl = curl_init();
        $message = "Terdapat Surat Baru dengan Jenis Surat = Surat Keterangan Nikah. dengan ID surat $id pada Halaman Permintaan Surat.";
        ...
        if (isset($response_data['status']) && $response_data['status'] == 'success') {
            ...
            $SQL = "UPDATE surat_keterangan_nikah_wali SET FLAG_SMS = 'N' WHERE id_sk = '$id'";
